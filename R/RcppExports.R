...
BReg <- function(X, Y, Bp, lam, nu, reps) {
    .Call('_BDFM_BReg', PACKAGE = 'BDFM', X, Y, Bp, lam, nu, reps)
}

BReg_diag <- function(X, Y, Bp, lam, nu, reps) {
    .Call('_BDFM_BReg_diag', PACKAGE = 'BDFM', X, Y, Bp, lam, nu, reps)
}
